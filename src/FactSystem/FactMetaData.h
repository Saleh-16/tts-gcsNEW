...
private:
    ...
    static QVariant _metersToKilometers(const QVariant &meters);
    static QVariant _kilometersToMeters(const QVariant &kilometers);
    static QVariant _metersToNauticalMiles(const QVariant &meters);
    static QVariant _nauticalMilesToMeters(const QVariant &nauticalMiles);
    ...
    static constexpr struct UnitConsts_s {
        ...
        static constexpr const qreal nauticalMilesToMeters = 1852.0;
    } constants{};
