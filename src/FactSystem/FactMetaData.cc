...
const FactMetaData::AppSettingsTranslation_s FactMetaData::_rgAppSettingsTranslations[] = {
    ...
    { "m",      "km",    FactMetaData::UnitHorizontalDistance,   UnitsSettings::HorizontalDistanceUnitsKilometers,    FactMetaData::_metersToKilometers,      FactMetaData::_kilometersToMeters },
    { "meter",  "km",    FactMetaData::UnitHorizontalDistance,   UnitsSettings::HorizontalDistanceUnitsKilometers,    FactMetaData::_metersToKilometers,      FactMetaData::_kilometersToMeters },
    { "meters", "km",    FactMetaData::UnitHorizontalDistance,   UnitsSettings::HorizontalDistanceUnitsKilometers,    FactMetaData::_metersToKilometers,      FactMetaData::_kilometersToMeters },
    { "m",      "NM",    FactMetaData::UnitHorizontalDistance,   UnitsSettings::HorizontalDistanceUnitsNauticalMiles, FactMetaData::_metersToNauticalMiles,   FactMetaData::_nauticalMilesToMeters },
    { "meter",  "NM",    FactMetaData::UnitHorizontalDistance,   UnitsSettings::HorizontalDistanceUnitsNauticalMiles, FactMetaData::_metersToNauticalMiles,   FactMetaData::_nauticalMilesToMeters },
    { "meters", "NM",    FactMetaData::UnitHorizontalDistance,   UnitsSettings::HorizontalDistanceUnitsNauticalMiles, FactMetaData::_metersToNauticalMiles,   FactMetaData::_nauticalMilesToMeters },
...
QVariant FactMetaData::_metersToKilometers(const QVariant &meters)
{
    return QVariant(meters.toDouble() / 1000.0);
}
QVariant FactMetaData::_kilometersToMeters(const QVariant &kilometers)
{
    return QVariant(kilometers.toDouble() * 1000.0);
}
QVariant FactMetaData::_metersToNauticalMiles(const QVariant &meters)
{
    return QVariant(meters.toDouble() / constants.nauticalMilesToMeters);
}
QVariant FactMetaData::_nauticalMilesToMeters(const QVariant &nauticalMiles)
{
    return QVariant(nauticalMiles.toDouble() * constants.nauticalMilesToMeters);
}
